...
img: assets/img/logo/logo_256x256.ico
importance: 1
category: work
...
<div class="row">
    <div class="col-sm mt-3 mt-md-9">
        {% include figure.liquid loading="eager" path="assets/img/gaitcyc.jpg" title="Gait Cycle" class="img-fluid rounded z-depth-1" %}
    </div>    
</div>
<div class="caption">
